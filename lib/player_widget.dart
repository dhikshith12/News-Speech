...
import 'package:listentonews/voice_connection.dart';
...
class _PlayerWidgetState extends State<PlayerWidget> {
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: CircularProgressIndicator(
            ...
            _position.inMilliseconds > 0 && _position.inMilliseconds < _duration.inMilliseconds) ? _position.inMilliseconds/_duration.inMilliseconds
            : 0,
          ),
        ),
        IconButton(icon: _isPlaying? Icon(Icons.pause,color: Colors.black,size: 45.0,):Icon(Icons.play_arrow,color: Colors.black,size: 45.0,),
        onPressed: (){
  ...
  Future<int> _play(String body) async {
    ...
    final playPosition = (_position != null &&
        ...
        ? _position
        : null;
    final result = await _audioPlayer.play(body,isLocal: true, position: playPosition);
